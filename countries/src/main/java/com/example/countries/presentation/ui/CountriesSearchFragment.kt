...
import com.example.countries.databinding.FragmentCountriesSearchBinding
import com.example.countries.presentation.viewmodel.CountrySearchViewModel
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED){
                countrySearchViewModel.countryInfoSharedFlow.collect{jsonInfoCountry->
                    ...
                    childFragmentManager.beginTransaction()
                        .replace(com.example.countries.R.id.detailsContainerInSearch, CountryDetailsFragment())
                        .addToBackStack(null)
                        .commit()
                }
            }
