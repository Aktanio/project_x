...
import com.example.countries.ui.CountriesSearchFragment.Companion.COUNTRY_DATA
import com.example.countries.ui.CountriesSearchFragment.Companion.KEY_FOR_FRAGMENT
    ...
    private val countryAdapter by lazy {
        CountryAdapter{selectedMeal->
            ...
            childFragmentManager.beginTransaction()
                .replace(com.example.countries.R.id.detailsContainerInList, CountryDetailsFragment())
                .addToBackStack(null)
                .commit()
        }
    }
